...
**Status: Waves 1–2 applied; dead interests table dropped (2026-08-27).** Wave 1 DEFINER RPCs (`20260827134743`, PR #4). Wave 2 storage (`20260827140913`, PR #5). `user_category_interests` dropped (`20260827150214`) — 6 leftover quiz rows, zero callers; do not RLS-wrap. **Next: Wave 3** RLS on `collectible_field_values` only (`trading_card_details` already gone). Canvas: `canvases/supabase-security-audit.canvas.tsx`.
