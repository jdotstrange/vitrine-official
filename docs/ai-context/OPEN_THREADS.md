...
**Status: Waves 1–5 applied (2026-08-27).** Wave 1 DEFINER RPCs (PR #4). Wave 2 storage (PR #5). Interests drop (PR #6). Wave 3 field-values RLS (PR #7). Waves 4–5 dictionaries + `search_path` / view invoker (`20260827174927`, `20260827174937`). **Next: Wave 6** drop leftover `collectible_field_values` — see `CODE_HYGIENE.md`. Deferred from Wave 5: HIBP (Auth dashboard; app is OTP) and policy initplan/dedupe (40+ policies). Canvas: `canvases/supabase-security-audit.canvas.tsx`.
