...
- Status: Active. Shipped 2026-05-26 on `main` (`c474d7c`–`c69300a`, founder dev-client validated). Preview binary rebuild still required for devices on pre-Reanimated-4.3 binaries — see OPEN_THREADS / EAS.
