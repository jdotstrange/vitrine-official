...
function RootLayout() {
  ...
  // KeyboardProvider above, this lets KeyboardAvoidingView / KeyboardAware-
  // ScrollView behave consistently across platforms. iOS handles this
  // natively via the keyboard frame, so no equivalent call is needed.
  useEffect(() => {
